...
export function galleryImageToLightbox(img: GalleryImage): ImageLightboxData | undefined {
  ...
  return {
    ...
    filmStockSlug: img.stockSlug?.trim() || null,
    reviewId: img.reviewId?.trim() || null,
    rollId: img.rollId?.trim() || null,
    uploadBatchId: img.uploadBatchId?.trim() || null,
    rollTitle: img.reviewTitle?.trim() ? img.reviewTitle.trim() : null,
...
export function filmUploadToLightboxData(
  ...
  return {
    ...
    filmStockSlug: u.film_stock_slug?.trim() || null,
    reviewId: u.review_id?.trim() || null,
    rollId: u.roll_id?.trim() || null,
    uploadBatchId: u.upload_batch_id?.trim() || null,
